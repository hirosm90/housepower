...
class WiSunRL7023 ( WiSunDevice ):
    ...
    def __init__( self, port, baud , type=DSS):
        ...
        self.scancache_path = tempfile.TemporaryDirectory(prefix='keilog_').name+'/scancache.json'
    ...
    def sendto( self, dataframe ):
        ...
        while True:
            ...
            elif res[:8] == b'SKSENDTO':
                continue

            else:
                logger.debug('unknown response : '+res.decode('ascii').strip())
